...
export const LeftToolbar: React.FC<LeftToolbarProps> = ({
  ...
  const templatePresets = [
    ...
    {
      id: 'canva-natal-ave-maria',
      title: 'Ave Maria Sacro • Rosas Douradas & Azul Royal',
      category: 'Datas Especiais',
      description: 'Design sacro requintado em azul marinho royal com silhueta luminosa, auréola dourada e tipografia de luxo.',
      imageUrl: CANVA_NATAL_AVE_MARIA_SVG,
      badge: '⭐ 5 Camadas Editáveis',
      layersCount: 5,
      getLayers: () => getNatalAveMariaTemplateLayers(Date.now()),
    },
    {
    ...
    },
    {
      ...
      title: 'Design Especial Caneca • Rui Tobias Carvalho',
      category: 'Floral & Natureza',
      description: 'Modelo oficial Canva Pro (DAHSwyjx7Qw) com 10 camadas editáveis: foto polaroid, aquarela nobre, borboleta e tipografia elegante.',
